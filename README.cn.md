...
[![x-cmd/install — k3s Code Quality Monitoring Repo Card](https://repo.x-cmd.io/k3s.svg?lang=zh)](https://x-cmd.com/install/k3s)
...
合计: **64,364** 行代码（覆盖前 5 种语言、共 **503** 个文件）。
...
- **最新版本**: `v1.37.0+k3s1` (2026-09-14)
- **最近提交**: 2026-09-18
- **Release 含资产**: 16 个

## 流行度

- **Star**: 34,006 · **Fork**: 2,728 · **开放 issue**: 7,762 · **贡献者**: 310

## 累计统计

- **发布数**: 1035 · **已合并 PR**: 4922 · **开放 PR**: 14 · **已关闭 issue**: 7664 · **开放 issue**: 98 · **提交数**: 4311
...
_数据快照: `data/card/260921.yml` · 2026-09-21T03:16:31Z._
