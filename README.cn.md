...
[![x-cmd/install — k3s Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/k3s.svg?lang=zh)](https://x-cmd.com/install/k3s)
...
合计: **64,362** 行代码（覆盖前 5 种语言、共 **503** 个文件）。
...
- **最新版本**: `v1.37.1-rc1+k3s1` (2026-09-14)
- **最近提交**: 2026-09-23
- **Release 含资产**: 16 个

## 流行度

- **Star**: 34,027 · **Fork**: 2,729 · **开放 issue**: 7,763 · **贡献者**: 310

## 累计统计

- **发布数**: 1039 · **已合并 PR**: 4938 · **开放 PR**: 15 · **已关闭 issue**: 7663 · **开放 issue**: 100 · **提交数**: 4317
...
_数据快照: `data/card/260924.yml` · 2026-09-24T03:06:22Z._
